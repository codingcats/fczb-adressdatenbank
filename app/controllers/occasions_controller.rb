class OccasionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @occasion.save
        format.html { redirect_to @occasion, notice: 'Anlass wurde erfolgreich angelegt.' }
  ...
  def update
    respond_to do |format|
      if @occasion.update(occasion_params)
        format.html { redirect_to @occasion, notice: 'Anlass wurde erfolgreich aktualisiert.' }
  ...
  def destroy
    @occasion.destroy
    respond_to do |format|
      format.html { redirect_to occasions_url, notice: 'Anlass wurde erfolgreich gelöscht.' }
